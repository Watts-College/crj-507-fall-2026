...
## Part V: Analytical Briefing

Prepare a 5–7 minute Analytical Briefing summarizing the most important findings from your final project. 
In creating your video, imagine that you are presenting your analysis to your supervisor, who wants to understand what the co-offending networks reveal and how they changed from 2023 to 2024.

It is up to you to determine which results, visualizations, and interpretations are most important to communicate. 
Your briefing should demonstrate your understanding of the network analysis techniques used in your report and, most importantly, explain what your findings mean.

Do not simply walk through or read your report. 
Approach the video as a professional briefing: identify the findings that matter, explain why they matter, and communicate them clearly to an audience that may not be familiar with network analysis.
...
Remember to ensure the following before submitting your assignment.
  ...
  * Name your files using this format: **Final-Project-LastName.rmd**, **Final_Project-LastName.html**, **Final Project-LastName.mp4**
